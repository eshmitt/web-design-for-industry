...
var values_1 = function (it) {
  ...
  return it === ArrayPrototype || (it instanceof Array && own === ArrayPrototype.values)
    // eslint-disable-next-line no-prototype-builtins
    || DOMIterables.hasOwnProperty(classof(it)) ? values$4 : own;
};
    ...
    if (isArray$4(options_1) && options_1.length) {
      forEach$2(options_1).call(options_1, function (_a, index) {
        ...
        if (ref && isDetached(ref) || forceDelete) {
          ...
          splice$2(options_1).call(options_1, index, 1);
        }
      });
...
function useForm(_a) {
  ...
  var setInternalValue = useCallback(function (name, value) {
    ...
    if (setDirty(name) || !get$1(touchedFieldsRef.current, name) && readFormStateRef.current.touched) {
      return !!set$5(touchedFieldsRef.current, name, true);
    }
  }, [setFieldValue]);
  ...
  var removeFieldEventListenerAndRef = useCallback(function (field, forceDelete) {
    ...
    forEach$2(_context2 = [dirtyFieldsRef, fieldsWithValidationRef, validFieldsRef, watchFieldsRef]).call(_context2, function (data) {
  ...
  function unregister(names) {
    if (!isEmptyObject(fieldsRef.current)) {
      ...
      forEach$2(_context3 = isArray$4(names) ? names : [names]).call(_context3, function (fieldName) {
  ...
  function registerFieldsRef(ref, validateOptions) {
    ...
    if (isRadioOrCheckbox ? currentField && isArray$4(currentField.options) && find$2(_context4 = currentField.options).call(_context4, function (_a) {
      var ref = _a.ref;
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
          ...
          switch (_c.label) {
            ...
            case 2:
              _a = _c.sent(), errors = _a.errors, values = values$5(_a);
            ...
            case 3:
              return [4
              /*yield*/
              , reduce$2(_context5 = values$2(fields)).call(_context5, function (previous, field) {
                return __awaiter(_this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      ...
                      case 2:
                        ...
                        values$5(resolvedPrevious)[name] = getFieldValue(fields, ref);
                        return [2
                        /*return*/
                        , promise$3.resolve(resolvedPrevious)];
                    }
            ...
            case 4:
              _b = _c.sent(), errors = _b.errors, values = values$5(_b);
              fieldErrors = errors;
              fieldValues = values;
              _c.label = 5;
  ...
  var reset = function (values) {
    ...
    forEach$2(_context6 = values$2(resetFieldArrayFunctionRef.current)).call(_context6, function (resetFieldArray) {
  ...
  useEffect(function () {
    return function () {
      ...
      fieldsRef.current && forEach$2(_context7 = values$2(fieldsRef.current)).call(_context7, function (field) {
...
var removeArrayAt = (function (data, index) {
  return isUndefined(index) ? [] : filter$2(data).call(data, function (_, i) {
    var _context;

    return indexOf$3(_context = isArray$4(index) ? index : [index]).call(_context, i) < 0;
  });
});
...
var slice_1 = function (it) {
  var own = it.slice;
  return it === ArrayPrototype$c || (it instanceof Array && own === ArrayPrototype$c.slice) ? slice$1 : own;
};
...
var insertAt = (function (data, index, value) {
  return __spread(slice$3(data).call(data, 0, index), isArray$4(value) ? value : [value || null], slice$3(data).call(data, index));
});
...
var useFieldArray = function (_a) {
  ...
  var remove = function (index) {
    ...
    if (readFormStateRef.current.isValid && !validateSchemaIsValid) {
      forEach$2(fields).call(fields, function (field, fieldIndex) {
        if (isUndefined(index) || fieldIndex === index || isArray$4(index) && indexOf$3(index).call(index, fieldIndex) >= 0) {
          for (var key in field) {
            var removeFieldName = name + "[" + index + "]." + key;
